...
wheels are attached to the GitHub Release (`adbcbridge-0.1.2-py3-none-<platform>.whl`),
so an offline machine can install one directly:

```sh
pip install ./adbcbridge-0.1.2-py3-none-manylinux2014_x86_64.manylinux_2_17_x86_64.manylinux_2_28_x86_64.whl
```

...
| OpenLink Virtuoso (`virtodbc.dll` 7.2.17, Windows) | Advertises the SQL_GD_* extensions but `SQLSetPos(SQL_POSITION)` fails on a block cursor. | `docs/COMPATIBILITY.md`, Windows column |

...
The release page also carries `SHA256SUMS`; `Get-FileHash adbcbridge-v0.1.1-win-x64.tar.gz -Algorithm SHA256`
in PowerShell gives the value to compare. [Security](../community/security.md#verifying-a-download)
covers checking the file's GPG signature, and the provenance and SBOM that releases after v0.1.1 add.
...
pip install adbcbridge-0.1.1-py3-none-win_amd64.whl

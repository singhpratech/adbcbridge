...
The release page also carries `SHA256SUMS`; `Get-FileHash adbcbridge-v0.1.3-win-x64.tar.gz -Algorithm SHA256`
...
pip install adbcbridge-0.1.3-py3-none-win_amd64.whl

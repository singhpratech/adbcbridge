...
| Release | v0.1.2: four prebuilt libraries, four wheels + sdist, crate, NuGet package, jar; on PyPI, crates.io, nuget.org and Maven Central; `SHA256SUMS`, its GPG signature, build provenance and an SBOM on the release ([how to verify](community/security.md#verifying-a-download)) |

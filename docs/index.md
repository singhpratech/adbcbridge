...
| Release | v0.1.0: four prebuilt libraries, four wheels + sdist, crate, NuGet package, jar; on PyPI, crates.io, nuget.org and Maven Central; `SHA256SUMS` on the release, and from the next release a GPG signature, build provenance and an SBOM ([how to verify](community/security.md#verifying-a-download)) |

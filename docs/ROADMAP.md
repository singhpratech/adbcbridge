...
| ADBC Driver Foundry validation suite ([`tests/validation/RESULTS.md`](../tests/validation/RESULTS.md)): SQLite 212/327 pass, PostgreSQL 265/327 pass on 2026-09-06; baseline findings D1–D9, D11, D14 fixed; D10/D12/D13 are SQLiteODBC's missing precision, verified on PostgreSQL as P1–P4 (TIME/TIMESTAMP precision and zone fidelity) plus P7 (`db_schema` option) and P8 (schema catalog fill), all small `src/` changes | in progress — P1–P4, P7, P8 next |
